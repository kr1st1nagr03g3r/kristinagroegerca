...
export default function Starfield({}) {
  ...
  return (
    <>
      <Container className={` scroller ${styles.container}`}>
        <section>
        ...
        <Container className={styles.whatever}>
          ...
          <Box className={styles.boxOne} sx={{ width: '50%' }}>
            <div className={styles.content}>
              <h2 className="font-serif white">
                I&apos;m comfortable working with a diverse range of tech and
                tools
              </h2>
              <div className={styles.button}>
                <Button className={` buttons ${styles.buttons}`}>
                  {props.buttontext}
                </Button>
              </div>
            </div>
